...
http://eol.org/collections/116394

Note that EOL collection JSON doesn't have URL or id for collection (!)

## JSON-LD for taxon

For taxon http://eol.org/pages/10692652 JSON-LD (traitbank) is:

http://eol.org/api/traits/10692652
